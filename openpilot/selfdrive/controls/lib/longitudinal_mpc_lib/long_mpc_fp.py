...
def get_jerk_factor(aggressive_jerk_acceleration=0.7, aggressive_jerk_danger=0.7, aggressive_jerk_speed=0.7,
                    ...
                    relaxed_jerk_acceleration=1.3, relaxed_jerk_danger=1.3, relaxed_jerk_speed=1.3,
...
#    return get_T_FOLLOW(personality)
  ...
  if personality==log.LongitudinalPersonality.relaxed:
    x_vel =  [0.0,  5.0,   10.0,   15.0,   20.0,   30.0,  40]
    y_dist = [2.0,  2.0,   1.75,   1.72,   3.10,   3.10,  3.1]
  elif personality==log.LongitudinalPersonality.standard:
    x_vel =  [0.0,  5.0,   10.0,   15.0,   20.0,   30.0,  40]
    y_dist = [2.0,  1.75,  1.50,   1.35,   3.10,   3.10,  3.1]
  elif personality==log.LongitudinalPersonality.aggressive:
    x_vel =  [0.0,  5.0,   10.0,   15.0,   20.0,   30.0,  40]
    y_dist = [2.0,  1.5,   1.35,   1.15,   3.10,   3.10,  3.1]
  else:
...
def desired_follow_distance(v_ego, v_lead, t_follow=1.2, personality=log.LongitudinalPersonality.standard):
#  if t_follow is None:
